...
The robot and the pocket watches use the **official Open Clowk artwork**
(claymation-style orange robot, brass watch whose face swings open). Sprites load from `assets/` if present, else from the CDN,
